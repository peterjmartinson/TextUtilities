drop table WALSH_SR123456_L;
create table WALSH_SR123456_L nologging as
select
  I.*
from
  WALSH_SR123456_PTS P
...
where E.ORDER_DATE >= to_date('01/01/2007','MM/DD/YYYY')
  and E.ORDER_DATE <= to_date('01/01/2016','MM/DD/YYYY')
;
